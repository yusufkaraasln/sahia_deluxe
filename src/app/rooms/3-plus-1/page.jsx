            ...
            <div className="row">
              ...
              <div className="col-lg-3 offset-lg-1 col-md-12">
                ...
                <ul className="list-unstyled page-list mb-30">
                  ...
                  <li>
                    <div className="page-list-text">
                      <p>115 m2 kapalı alan, yarı korumalı 50-100 m2 bahçe alanı  </p>
                    </div>
                  </li>
                  <li>
                    <div className="page-list-text">
                  ...
                  <li>
                    <div className="page-list-text">
                      <p>2 adet iki ayrı yataklı oda</p>
                    </div>
                  </li>
                  <li>
                    <div className="page-list-text">
                      <p>Geniş havuz, büyük bahçe alanı &#40;100m2&#41;</p>
                    </div>
                  </li>
                </ul>
              </div>
